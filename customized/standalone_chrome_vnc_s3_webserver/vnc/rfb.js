...
export default class RFB extends EventTargetMixin {
    constructor(target, urlOrChannel, options) {
        ...
        // event.initEvent("CUSTOM_CANVAS_CREATED", true, true);
        // window.dispatchEvent(event);

        this._canvas.addEventListener('focus', function() {
            console.log("canvas focussed")
            const event = new Event("CUSTOM_CANVAS_CREATED");
            window.dispatchEvent(event);
        })
